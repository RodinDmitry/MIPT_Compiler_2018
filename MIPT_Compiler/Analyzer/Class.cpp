...
std::string CClassInternals::GetLabel() const
{
...
std::string CClassDeclaration::GetLabel() const
{
...
std::string CClass::GetLabel() const
{
...
std::string CClassInternalsList::GetLabel() const
{
...
std::string CClassList::GetLabel() const
{
